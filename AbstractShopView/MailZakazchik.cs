...
{
    public static class MailZakazchik
    {
        private static TcpClient mailZakazchik;
        ...
        public static void Connect()
        {
            ...
            mailZakazchik = new TcpClient();
            mailZakazchik.Connect("pop.gmail.com", 995);

            stream = new SslStream(mailZakazchik.GetStream());
        ...
        private static string GetBody(string response, string coding)
        {
            ...
            while (!response.StartsWith("Content-Type: text") && response != ".")
            {
                response = reader.ReadLine();
            }
