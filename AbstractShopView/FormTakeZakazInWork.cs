    ...
    public partial class FormTakeZakazInWork : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                task.ContinueWith((prevTask) => MessageBox.Show("На занятие назначен преподаватель. Обновите список", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information),
