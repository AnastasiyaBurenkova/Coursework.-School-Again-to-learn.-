...
namespace AbstractShopView
{
    public partial class FormMain : Form
    {
        ...
        {
            var form = new FormBonusFineBlocks();
            form.ShowDialog();
        }
        ...
        {
            var form = new FormPutOnBonusFineBlock();
            form.ShowDialog();
        }
        ...
        private void buttonZakazReady_Click(object sender, EventArgs e)
        {
            if (dataGridView.SelectedRows.Count == 1)
            {
                ...
                task.ContinueWith((prevTask) => MessageBox.Show("Статус занятия изменен. Обновите список", "Успех", MessageBoxButtons.OK, MessageBoxIcon.Information),
        ...
        {
            var form = new FormBonusFineBlocksLoad();
            form.ShowDialog();
        }
